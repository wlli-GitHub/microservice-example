    ...
    public static String generate(String password , String salt) {
     ...
     // 测试主函数  
        public static void main(String args[]) {  
            ...
            // 获取加盐后的MD5值  
            String ciphertext = Md5SaltToolUtil.generate(plaintext,getSalt());
            System.out.println("加盐后MD5：" + ciphertext);  
            System.out.println("是否是同一字符串:" + Md5SaltToolUtil.verify(plaintext, ciphertext));
            /**  
             * 其中某次DingSai字符串的MD5值  
             */  
            ...
            for (String temp : tempSalt) {  
                System.out.println("是否是同一字符串:" + Md5SaltToolUtil.verify(plaintext, temp));
            }  
